...
# Sidebar with Logo
st.sidebar.image("logo2.png",  use_container_width=True, caption="Leaf Recognition with AI")

st.sidebar.title("LeafHealth AI")
app_mode = st.sidebar.radio("Navigate", ["Home", "About", "Leaf Disease Recognition"], index=0)
st.sidebar.markdown("---")
st.sidebar.info(" Upload photo of leaf images for quick disease diagnosis")

# Home Page
if app_mode == "Home":
    st.header(" Smart Leaf Disease Recognition System")
    st.markdown("---")
    ...
    **Our mission**: Empower farmers with instant plant disease detection using advanced AI technology. 
    ...
    ### Getting Started
    👉 Select **Crop Leaf Disease Recognition** from the sidebar to begin your analysis!
    """)
...
# About Page
    ...
    with st.expander("🛠️ Technical Architecture"):
        ...
        - **Accuracy**: 98.3% validation accuracy
        ...
        if st.button(" Start Analysis ", type="primary"):
            with st.spinner("🔍 Analyzing leaf patterns..."):
                ...
                <div class="prediction-result">
                    ...
                    <h3 style="color:#d32f53;">Condition: {disease}</h3>
                </div>
                """, unsafe_allow_html=True)
